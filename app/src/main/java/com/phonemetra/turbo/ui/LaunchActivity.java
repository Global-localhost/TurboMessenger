...
import com.phonemetra.turbo.messenger.LocationController;
...
import com.phonemetra.turbo.messenger.NativeCrashManager;
...
import com.phonemetra.turbo.messenger.camera.CameraController;
...
import com.phonemetra.turbo.ui.Adapters.DrawerLayoutAdapter;
import com.phonemetra.turbo.ui.ActionBar.ActionBarLayout;
import com.phonemetra.turbo.ui.ActionBar.BaseFragment;
import com.phonemetra.turbo.ui.ActionBar.DrawerLayoutContainer;
import com.phonemetra.turbo.ui.Cells.LanguageCell;
import com.phonemetra.turbo.ui.Components.AudioPlayerAlert;
        ...
        if (!fromPassword && (AndroidUtilities.needShowPasscode(true) || UserConfig.isWaitingForPasscodeEnter)) {
            ...
            if (UserConfig.isClientActivated() && (flags & Intent.FLAG_ACTIVITY_LAUNCHED_FROM_HISTORY) == 0) {
                if (intent != null && intent.getAction() != null && !restore) {
                    ...
                    } else if (intent.getAction().equals("com.phonemetra.turbo.messenger.OPEN_ACCOUNT")) {
                        open_settings = 1;

 ...
 */
package com.phonemetra.turbo.messenger.exoplayer2;
...
import com.phonemetra.turbo.messenger.exoplayer2.audio.AudioCapabilities;
import com.phonemetra.turbo.messenger.exoplayer2.audio.AudioProcessor;
import com.phonemetra.turbo.messenger.exoplayer2.audio.AudioRendererEventListener;
import com.phonemetra.turbo.messenger.exoplayer2.audio.MediaCodecAudioRenderer;
import com.phonemetra.turbo.messenger.exoplayer2.drm.DrmSessionManager;
import com.phonemetra.turbo.messenger.exoplayer2.drm.FrameworkMediaCrypto;
import com.phonemetra.turbo.messenger.exoplayer2.mediacodec.MediaCodecSelector;
import com.phonemetra.turbo.messenger.exoplayer2.metadata.MetadataRenderer;
import com.phonemetra.turbo.messenger.exoplayer2.text.TextRenderer;
import com.phonemetra.turbo.messenger.exoplayer2.trackselection.TrackSelector;
import com.phonemetra.turbo.messenger.exoplayer2.video.MediaCodecVideoRenderer;
import com.phonemetra.turbo.messenger.exoplayer2.video.VideoRendererEventListener;
...
public class DefaultRenderersFactory implements RenderersFactory {
  ...
  protected void buildVideoRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("com.phonemetra.turbo.messenger.exoplayer2.ext.vp9.LibvpxVideoRenderer");
  ...
  protected void buildAudioRenderers(Context context,
    ...
    try {
      Class<?> clazz =
          Class.forName("com.phonemetra.turbo.messenger.exoplayer2.ext.opus.LibopusAudioRenderer");
    ...
    try {
      Class<?> clazz =
          Class.forName("com.phonemetra.turbo.messenger.exoplayer2.ext.flac.LibflacAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
    ...
    try {
      Class<?> clazz =
          Class.forName("com.phonemetra.turbo.messenger.exoplayer2.ext.ffmpeg.FfmpegAudioRenderer");
      Constructor<?> constructor = clazz.getConstructor(Handler.class,
          AudioRendererEventListener.class, AudioProcessor[].class);
      Renderer renderer = (Renderer) constructor.newInstance(eventHandler, eventListener,
          audioProcessors);
